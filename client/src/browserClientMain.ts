...
export function activate(context: ExtensionContext) {
    ...
    const request_handlers: { [cmd: string]: any } = {
        ...
        'ahk2.getWorkspaceFileContent': async (params: string[]) =>
            (await workspace.openTextDocument(Uri.parse(params[0]))).getText(),
    };
    ...
    client = new LanguageClient(
        ...
        'AutoHotkey2',
        {
            ...
            initializationOptions: {
                ...
                ...JSON.parse(
                    JSON.stringify(workspace.getConfiguration('AutoHotkey2')),
                ),
            },
        },
