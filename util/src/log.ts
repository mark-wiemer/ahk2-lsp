...
export const trace = (value: Error | string, logFunc: (val: string) => void = console.log) => log(value, LogLevel.Trace, logFunc);
export const debug = (value: Error | string, logFunc: (val: string) => void = console.log) => log(value, LogLevel.Debug, logFunc);
export const info = (value: Error | string, logFunc: (val: string) => void = console.log) => log(value, LogLevel.Info, logFunc);
export const warn = (value: Error | string, logFunc: (val: string) => void = console.log) => log(value, LogLevel.Warn, logFunc);
export const error = (value: Error | string, logFunc: (val: string) => void = console.log) => log(value, LogLevel.Error, logFunc);
export const critical = (value: Error | string, logFunc: (val: string) => void = console.log) => log(value, LogLevel.Critical, logFunc);